export const ru = {
    translations: {
        ...
        settings: {
            ...
            minFan: "Минимальный балл:",
            minFanLimit: "(Максимальный балл: 10)",
        ...
        analyzer: {
            ...
            startingHand: "Ваша стартовая рука: {{hand}}. Улучшений до тенпая: {{count}}.",
            startingHand_plural: "Ваша стартовая рука: {{hand}}. Улучшений до тенпая: {{count}}.",
